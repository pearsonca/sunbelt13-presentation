...
\author{Carl~A.~B.~Pearson \and Burton H. Singer}
...
{\em a covert network} is a sub graph where edge information is unavailable, unreliable, or indistinguishable from whole graph structure
\end{block}
...
\usebackgroundtemplate{\includegraphics[width=0.9\paperheight,height=0.9\paperheight]{4_1_500_s.png}}
\frame{
\begin{columns}[t]
\begin{column}{0.7\textwidth}\end{column}
\begin{column}{0.3\textwidth}
...
\usebackgroundtemplate{\includegraphics[width=0.9\paperheight,height=0.9\paperheight]{4_1_500_c.png}}
\frame{
\begin{columns}[t]
\begin{column}{0.7\textwidth}\end{column}
\begin{column}{0.3\textwidth}
...
\usebackgroundtemplate{\includegraphics[width=0.9\paperheight,height=0.9\paperheight]{4_1_500_sandc.png}}
\frame{
\begin{columns}[t]
\begin{column}{0.7\textwidth}\end{column}
\begin{column}{0.3\textwidth}
